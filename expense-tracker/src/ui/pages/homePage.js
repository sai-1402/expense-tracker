...
export function renderHomePage() {
    ...
    document.getElementById('home-page').innerHTML = `
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            <div class="bg-violet-200 p-6 rounded-xl shadow-sm"><h3 class="text-slate-500 font-medium">Net Balance</h3><p class="text-3xl font-bold text-slate-800 mt-2">￥${balance.toLocaleString()}</p></div>
        </div>
